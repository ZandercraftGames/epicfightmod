...
public class Colliders
{
	...
	public static Collider spearNarrow = new ColliderOBB(0.25F, 0.25F, 0.9F, 0F, 0F, -1.35F);
	...
	{
		//Collider newCOllider = new ColliderOBB(0.4F, 0.8F, 0.75F, 0F, 0F, -0.3F);
		//((AttackAnimation)Animations.SWEEPING_EDGE).changeCollider(newCOllider, 0);
		//((AttackAnimation)Animations.RAVAGER_ATTACK2).changeCollider(newCOllider, 0);
		//((AttackAnimation)Animations.RAVAGER_ATTACK3).changeCollider(newCOllider, 0);
	}
}