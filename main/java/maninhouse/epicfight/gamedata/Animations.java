...
import maninhouse.epicfight.animation.types.DeathAnimation;
...
public final class Animations
{
	...
	public static StaticAnimation HOGLIN_DEATH_CHILD;
	public static StaticAnimation HOGLIN_ATTACK;
	public static StaticAnimation HOGLIN_ATTACK_CHILD;
	...
	public static void registerAnimations(Dist dist)
	{
		...
		Armature hoglin_child = modeldata.ENTITY_HOGLIN_CHILD.getArmature();
		...
		BABY_RUN = new MovementAnimation(104, true, "zombie/baby_run.dae").bindOnlyClient(biped_child, dist);
		...
		FIST_DASH = new AADashAnimation(2004, 0.06F, 0.05F, 0.15F, 0.3F, 0.7F, null, "213", "biped/combat/fist_dash.dae").bindFull(biped);
		...
		SWORD_DASH = new AADashAnimation(2008, 0.12F, 0.1F, 0.25F, 0.4F, 0.65F, Colliders.swordDash, "111213", "biped/combat/sword_dash.dae").bindFull(biped);
		...
		GREATSWORD_DASH = new AADashAnimation(2011, 0.11F, 0.4F, 0.65F, 0.8F, 1.2F, null, "111213", "biped/combat/greatsword_dash.dae").bindFull(biped);
		SPEAR_ONEHAND_AUTO = new AAAnimation(2012, 0.16F, 0.2F, 0.3F, 0.45F, 1.2F, null, "111213", "biped/combat/spear_onehand_auto.dae").bindFull(biped);
		...
		SPEAR_DASH = new AADashAnimation(2015, 0.16F, 0.1F, 0.25F, 0.5F, 1.2F, null, "111213", "biped/combat/spear_dash.dae").bindFull(biped);
		...
		AXE_DASH = new AADashAnimation(2019, 0.25F, 0.08F, 0.4F, 0.46F, 0.9F, null, "111213", "biped/combat/axe_dash.dae").bindFull(biped);
		...
		SWORD_DUAL_DASH = new AADashAnimation(2023, 0.16F, 0.1F, 0.1F, 0.3F, 0.65F, Colliders.dualSwordDash, "", "biped/combat/dual_dash.dae").bindFull(biped);
		...
		KATANA_SHEATHING_AUTO = new AAAnimation(2027, 0.06F, 0.0F, 0.06F, 0.65F, 2.0F, Colliders.fatal_draw, "", "biped/combat/katana_reinforce_auto.dae")
				.addProperty(AnimationProperty.SURESTRIKE, null)
				.addProperty(AnimationProperty.ARMOR_IGNORANCE, 30.0F)
		...
		KATANA_SHEATHING_DASH = new AAAnimation(2028, 0.06F, 0.05F, 0.11F, 0.65F, 2.0F, null, "111213", "biped/combat/katana_reinforce_dash.dae")
				...
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_SHARP).bindFull(biped);
		AXE_AUTO1 = new AAAnimation(2029, 0.16F, 0.2F, 0.3F, 0.7F, 1.0F, null, "111213", "biped/combat/axe_auto1.dae").bindFull(biped);
		AXE_AUTO2 = new AAAnimation(2030, 0.16F, 0.2F, 0.3F, 0.85F, 1.0F, null, "111213", "biped/combat/axe_auto2.dae").bindFull(biped);
		...
		BIPED_DEATH = new DeathAnimation(3003, 0.16F, "biped/living/death.dae").bindFull(biped);
		...
		CREEPER_DEATH = new DeathAnimation(3402, 0.16F, "creeper/death.dae").bindFull(crepper);
		...
		ENDERMAN_HIT_RAGE = new HitAnimation(3006, 0.16F, "enderman/convert_rampage.dae").bindFull(enderman);
		...
		ENDERMAN_DEATH = new DeathAnimation(3016, 0.16F, "enderman/death.dae").bindFull(enderman);
		...
		SPIDER_DEATH = new DeathAnimation(3103, 0.16F, "spider/death.dae").bindFull(spider);
		...
		GOLEM_DEATH = new DeathAnimation(3204, 0.11F, "iron_golem/death.dae").bindFull(iron_golem);
		...
		PIGLIN_DEATH = new DeathAnimation(6000, 0.16F, "piglin/death.dae").bindFull(piglin);
		
		HOGLIN_DEATH = new DeathAnimation(6050, 0.16F, "hoglin/death.dae").bindFull(hoglin);
		HOGLIN_DEATH_CHILD = new DeathAnimation(6051, 0.16F, "hoglin/child_death.dae").bindFull(hoglin_child);
		HOGLIN_ATTACK = new TargetTraceAnimation(6052, 0.16F, 0.25F, 0.25F, 0.35F, 1.0F, false, Colliders.golemSwingArm, "1", "hoglin/attack.dae").bindFull(hoglin);
		HOGLIN_ATTACK_CHILD = new TargetTraceAnimation(6053, 0.16F, 0.25F, 0.25F, 0.35F, 1.0F, false, Colliders.golemSwingArm, "1", "hoglin/child_attack.dae").bindFull(hoglin_child);
		
		RAVAGER_DEATH = new DeathAnimation(3600, 0.11F, "ravager/death.dae").bindFull(ravager);
		...
		VEX_DEATH = new DeathAnimation(3309, 0.16F, "vex/death.dae").bindFull(vex);
		...
		BABY_DEATH = new DeathAnimation(4003, 0.16F, "zombie/baby_death.dae").bindFull(biped_child);
		
		SWEEPING_EDGE = new AttackAnimation(4111, 0.11F, 0.1F, 0.5F, 0.6F, 0.9F, false, Colliders.swordSwingFast, "111213", "biped/skill/sweeping_edge.dae")
				.addProperty(AnimationProperty.HIT_AT_ONCE, 3)
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 2.0F)
				.addProperty(AnimationProperty.ARMOR_IGNORANCE, 20.0F)
				.addProperty(AnimationProperty.STUN_TYPE, StunType.LONG).bindFull(biped);
		
		DANCING_EDGE = new AttackAnimation(4112, 0.25F, true, "biped/skill/dancing_edge.dae",
				...
				.addProperty(AnimationProperty.HIT_AT_ONCE, 3)
				.addProperty(AnimationProperty.IMPACT, 1.5F).bindFull(biped);
		
		GUILLOTINE_AXE = new AttackAnimation(5000, 0.08F, 0.2F, 0.5F, 0.65F, 1.0F, true, null, "111213", "biped/skill/axe_special.dae")
				.addProperty(AnimationProperty.HIT_AT_ONCE, 1)
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 2.5F)
				.addProperty(AnimationProperty.ARMOR_IGNORANCE, 40.0F)
				.addProperty(AnimationProperty.STUN_TYPE, StunType.LONG).bindFull(biped);
		
		SPEAR_THRUST = new AttackAnimation(5001, 0.11F, false, "biped/skill/spear_thrust.dae",
				...
				new Phase(0.73F, 0.73F, 0.78F, 0.78F, "111213", Colliders.spearNarrow))
				.addProperty(AnimationProperty.STUN_TYPE, StunType.HOLD)
				.bindFull(biped);
		
		SPEAR_SLASH = new AttackAnimation(5002, 0.1F, false, "biped/skill/spear_slash.dae",
				...
				.addProperty(AnimationProperty.IMPACT, 2.0F).bindFull(biped);
		
		GIANT_WHIRLWIND = new AttackAnimation(5003, 0.41F, false, "biped/skill/giant_whirlwind.dae",
		...
		FATAL_DRAW = new AttackAnimation(5004, 0.15F, 0.0F, 0.7F, 0.8F, 1.4F, false, Colliders.fatal_draw, "", "biped/skill/fatal_draw.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 2.0F)
				.addProperty(AnimationProperty.ARMOR_IGNORANCE, 70.0F)
				.addProperty(AnimationProperty.HIT_AT_ONCE, 8)
				.addProperty(AnimationProperty.STUN_TYPE, StunType.HOLD)
		...
		FATAL_DRAW_DASH = new AttackAnimation(5005, 0.15F, 0.43F, 0.85F, 0.91F, 1.8F, false, Colliders.fatal_draw_dash, "", "biped/skill/fatal_draw_dash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 2.0F)
				.addProperty(AnimationProperty.ARMOR_IGNORANCE, 70.0F)
				.addProperty(AnimationProperty.HIT_AT_ONCE, 8)
				.addProperty(AnimationProperty.STUN_TYPE, StunType.HOLD)
