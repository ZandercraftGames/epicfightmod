...
public class VanillaArmorCapability extends ArmorCapability
{
	...
	public ClientModel getEquipModel(EquipmentSlotType slot, boolean smallsize)
	{
		...
		{
		case HEAD:
			return smallsize ? ClientModels.LOGICAL_CLIENT.ITEM_HELMET_FOR_CHILD : ClientModels.LOGICAL_CLIENT.ITEM_HELMET;
		case CHEST:
			return smallsize ? ClientModels.LOGICAL_CLIENT.ITEM_CHESTPLATE_FOR_CHILD : ClientModels.LOGICAL_CLIENT.ITEM_CHESTPLATE;
		case LEGS:
			return smallsize ? ClientModels.LOGICAL_CLIENT.ITEM_LEGGINS_FOR_CHILD : ClientModels.LOGICAL_CLIENT.ITEM_LEGGINS;
		case FEET:
			return smallsize ? ClientModels.LOGICAL_CLIENT.ITEM_BOOTS_FOR_CHILD : ClientModels.LOGICAL_CLIENT.ITEM_BOOTS;
		default:
			return null;
		}
	}
