...
public class SkillContainer
{
	...
	public float getCooldownRatio()
	{
		return containingSkill != null && containingSkill.cooldown > 0 ? (prevCooldown + ((cooldown - prevCooldown) *
				ClientEngine.INSTANCE.renderEngine.getPartialTicks())) / containingSkill.cooldown : 0;
	}
	...
	public float getDurationRatio()
	{
		return containingSkill != null && containingSkill.duration > 0 ? (prevDuration + ((duration - prevDuration) *
				ClientEngine.INSTANCE.renderEngine.getPartialTicks())) / containingSkill.duration : 0;
	}
}