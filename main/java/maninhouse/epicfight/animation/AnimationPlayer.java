...
public class AnimationPlayer
{
	...
	public Pose getCurrentPose(LivingData<?> entitydata, float interpolation)
	{
		return play.getPoseByTime(entitydata, prevElapsedTime + (elapsedTime - prevElapsedTime) * interpolation);
	}
